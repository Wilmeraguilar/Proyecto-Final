...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                .authorizeRequests()
                    .antMatchers("/css/**", "/imagenes/**", "/assets/**", "/js/**", "/vendor/**", "/usuarios/crear", "/login/elegir","/usuarios/guardar", "/gimnasios/crear", "/gimnasios/guardar", "/gimnasios", "/gimnasios/buscar/provinciaCiudad","/reservas/horarios", "/gimnasios/staff").permitAll()
